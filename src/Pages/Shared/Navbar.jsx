...
const Navbar = () => {
    ...
    const [darkTheme, setDarkTheme] = useState(localStorage.getItem("theme") ? localStorage.getItem("theme") : "emerald")
    useEffect(() => {
        ...
        <div>
            <div className="navbar bg-base-100 mt-3">
                <div className="navbar-start">
                    ...
                    {/* <img src={logo} alt="" /> */}
                    <h2 className="text-xl font-bold text-primary">Clean Co</h2>
                </div>
